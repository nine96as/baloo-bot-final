...
/**
 * Checks for a LogSystem entry for the specific guild, where the log message is
 * sent if the entry is found.
 * @param {Guild} guild The guild to check against.
 * @param {InfoEmbed} embed The embed message to be sent.
 */
export const sendLogMessage = async (guild: Guild, embed: InfoEmbed) => {
